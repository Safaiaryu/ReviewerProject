namespace ReviewerProject.Migrations
{
    ...
    public partial class IdentityModelsDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        MaterialName = c.String(maxLength: 30),
                        Description = c.String(maxLength: 250),
                        Type = c.Int(nullable: false),
                        Equipment_ID = c.Int(),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        EidolonName = c.String(maxLength: 20),
                        Description = c.String(maxLength: 100),
                        MagiciteAbilty = c.String(maxLength: 100),
                        Magicite_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        MonsterName = c.String(maxLength: 50),
                        Description = c.String(maxLength: 250),
